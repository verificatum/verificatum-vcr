...
dnl
dnl This file is part of Verificatum Core Routines (VCR).
dnl
dnl VCR is free software: you can redistribute it and/or modify it under
dnl the terms of the GNU Affero General Public License as published by
dnl the Free Software Foundation, either version 3 of the License, or
dnl (at your option) any later version.
dnl
dnl VCR is distributed in the hope that it will be useful, but WITHOUT
...
dnl License along with VCR. If not, see <http://www.gnu.org/licenses/>.
dnl
